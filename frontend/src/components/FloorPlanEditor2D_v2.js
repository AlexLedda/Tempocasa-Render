...
const FloorPlanEditor2D = ({ floorPlanImage, threeDData, onSave }) => {
  ...
  useEffect(() => {
    drawCanvas();
  }, [rooms, doors, windows, walls, floors, selectedElement, hoveredElement, furniture, backgroundImg, mousePos, isDrawing, startPoint, mode, imageScale, imagePosition, imageOpacity, isResizing, wallColor]);
          ...
          {mode === 'move' && (
            <div className="bg-purple-50 p-3 rounded-lg">
              <p className="text-sm text-purple-800">
                🖐️ <strong>Modalità Sposta Libero:</strong> Passa il mouse sopra qualsiasi elemento e trascinalo direttamente nella nuova posizione. Cursore 🖐️ indica che puoi spostare.
              </p>
            </div>
          )}
          {mode === 'wall' && (
